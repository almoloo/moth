...
export type Moth = {
  ...
  methods:
    ...
    & Record<'GatewaySpendToken(pay,address,uint64,uint64)uint64' | 'GatewaySpendToken', {
      argsObj: {
        payment: TransactionToSign | Transaction | Promise<SendTransactionResult>
        toAddress: string
...
export abstract class MothCallFactory {
  ...
  /**
   * Constructs a no op call for the GatewaySpendToken(pay,address,uint64,uint64)uint64 ABI method
   *
   * @param args Any args for the contract call
   * @param params Any additional parameters for the call
   * @returns A TypedCallParams object for the call
   */
  static gatewaySpendToken(args: MethodArgs<'GatewaySpendToken(pay,address,uint64,uint64)uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'GatewaySpendToken(pay,address,uint64,uint64)uint64' as const,
...
export class MothClient {
  ...
  /**
   * Calls the GatewaySpendToken(pay,address,uint64,uint64)uint64 ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The result of the call
   */
  public gatewaySpendToken(args: MethodArgs<'GatewaySpendToken(pay,address,uint64,uint64)uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
  ...
  public compose(): MothComposer {
    ...
    return {
      ...
      gatewaySpendToken(args: MethodArgs<'GatewaySpendToken(pay,address,uint64,uint64)uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
...
export type MothComposer<TReturns extends [...any[]] = []> = {
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  gatewaySpendToken(args: MethodArgs<'GatewaySpendToken(pay,address,uint64,uint64)uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): MothComposer<[...TReturns, MethodReturn<'GatewaySpendToken(pay,address,uint64,uint64)uint64'>]>
